...
**Student & C / C++ Programmer**
[oussamaaitsaid1337@gmail.com](mailto:oussamaaitsaid1337@gmail.com)
...
* Languages: C, C++
* Tools: Git, GCC, Makefile, VS Code
* Concepts: Data Structures, Algorithms, Memory Management, OOP (C++)
* Practices: Documentation, Code Review, Testing
...
Student in Software Development; self-directed study in C/C++, data structures, and operating systems.

---

## Topics

`C`, `C++`, `Algorithms`, `Data-Structures`, `Low-Level`, `Systems`, `Git`, `Code-Review`, `Documentation`
